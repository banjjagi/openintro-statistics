...
\usepackage[style=authortitle-ibid, maxnames=2,natbib=true,sortcites=true,block=space,backend=biber, bibencoding=utf8]{biblatex}
...
\renewcommand{\thepage}{}
% \maketitle % 개발위해 제외
% \include{extraTeX/preamble/copyright}%_derivative} % 개발위해 제외
\renewcommand{\thepage}{\arabic{page}}
% \tableofcontents %개발위해 제외
% \include{extraTeX/preamble/preface} % 개발위해 제외
\normalsize
